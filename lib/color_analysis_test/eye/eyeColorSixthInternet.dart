...
class EyeColorSixthInternet extends StatefulWidget {
  const EyeColorSixthInternet({Key? key}) : super(key: key);

  @override
  _EyeColorSixthInternetState createState() => _EyeColorSixthInternetState();
}

class _EyeColorSixthInternetState extends State<EyeColorSixthInternet> {
  List<EyeColors> notes = <EyeColors>[];

  fetchNotes() async {
    var url = "https://yourbestcolors.cyou/wp-json/test/v1/question/9";
        ...
        child: Column(
          children: [
            const QuestionConstant(
              question: '6. Which color best describes your eye color?',
            ),
            Expanded(
              child: FutureBuilder(
                future: fetchNotes(),
