...
class EyeColorSecondInternet extends StatefulWidget {
  const EyeColorSecondInternet({Key? key}) : super(key: key);

  @override
  _EyeColorSecondInternetState createState() => _EyeColorSecondInternetState();
}

class _EyeColorSecondInternetState extends State<EyeColorSecondInternet> {
  List<EyeColors> notes = <EyeColors>[];

  fetchNotes() async {
    var url = "https://yourbestcolors.cyou/wp-json/test/v1/question/4";
