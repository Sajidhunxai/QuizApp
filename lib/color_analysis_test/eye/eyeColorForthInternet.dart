...
import 'eyeColorFifthInternet.dart';
import 'eyeColorFirstLocal.dart';

class EyeColorForthInternet extends StatefulWidget {
  const EyeColorForthInternet({Key? key}) : super(key: key);

  @override
  _EyeColorForthInternetState createState() => _EyeColorForthInternetState();
}

class _EyeColorForthInternetState extends State<EyeColorForthInternet> {
  List<EyeColors> notes = <EyeColors>[];

  fetchNotes() async {
    var url = "https://yourbestcolors.cyou/wp-json/test/v1/question/7";
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EyeColorFifthInternet(),
                                ),
                              );
                            },
                            child: Padding(
