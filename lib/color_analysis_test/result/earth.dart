...
class EarthResult extends StatefulWidget {
  const EarthResult({Key? key}) : super(key: key);

  @override
  _EarthResultState createState() => _EarthResultState();
}

class _EarthResultState extends State<EarthResult> {
  @override
